...
public interface Encoder3<T1, T2, T3> extends EncoderBase<Encoder3<T1, T2, T3>> {
  ...
  default Encoder3<T1, T2, T3> prepend(ConstExpr c) {
    return (val1, val2, val3) -> ConstExpr.combine(c, Encoder3.this.encode(val1, val2, val3));
  }

  @Override
  default Encoder3<T1, T2, T3> append(ConstExpr c) {
    return (val1, val2, val3) -> ConstExpr.combine(Encoder3.this.encode(val1, val2, val3), c);
  }
}
